export const authTypeDefs = /* GraphQL */ `
  ...
  input AdminCreateUserInput {
    ...
    phone: String
    city: String
    tenantId: ID            # required when role is FRANCHISE_OWNER / FRANCHISE_STAFF
  }
  ...
  extend type Mutation {
    ...
    """ SUPER_ADMIN/SUPPORT_AGENT only: create any user (customer, franchise staff/owner, or platform admin). """
    adminCreateUser(input: AdminCreateUserInput!): User!

    """ SUPER_ADMIN/SUPPORT_AGENT only: edit any user's profile/role/tenant. """
    adminUpdateUser(id: ID!, input: AdminUpdateUserInput!): User!

    """ SUPER_ADMIN/SUPPORT_AGENT only: soft-delete a user account. """
